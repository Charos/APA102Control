...
JNIEXPORT jint JNICALL Java_bfh_ti_i2c_1jni_1template_I2C_SetSlaveAddress(JNIEnv *env, jobject obj, jint file, jint slaveAddr)
{
#ifndef EMULATOR
...
if (bytesWritten != len)
{
LOGE("Write to the i2c device failed!");
return -1;
}
return bytesWritten;
